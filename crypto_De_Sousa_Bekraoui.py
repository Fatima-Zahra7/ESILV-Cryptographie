  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Fatima-Zahra7/ESILV-Cryptographie/blob/main/crypto_De_Sousa_Bekraoui.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "a1100bc2-eb19-420c-edde-3382c3898093"
      },
      "execution_count": null,
      "outputs": [
        {
